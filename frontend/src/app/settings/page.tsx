                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex max-w-md items-center rounded-xl border border-slate-300 bg-slate-50 dark:border-slate-700 dark:bg-slate-900">
                        ...
                        <input type="text" readOnly value="suhas" className="w-full flex-1 rounded-r-xl border-none bg-transparent py-2 pr-4 text-sm text-slate-400 outline-none cursor-not-allowed" />
                      </div>
                    </div>
                    <div className="pt-4">
